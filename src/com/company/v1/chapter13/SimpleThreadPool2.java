...
public class SimpleThreadPool2 {
    ...
    public SimpleThreadPool2(int size, int taskSize,DiscardStrategy discardStrategy) {
        this.size = size;
    ...
    public static void main(String[] args) {
        SimpleThreadPool2 simpleThreadPool = new SimpleThreadPool2(6,10,DEFAULT_DISCARD_STRATEGY);
